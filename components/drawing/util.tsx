...
export function useDrag(onDrag: (arg0: THREE.Vector3) => void, onDragEnd: () => void) {
...
export function useHover() {
    ...
    const enter = useCallback((e: ThreeEvent<PointerEvent>) => setIsHovered(true), []);
    const out = useCallback((e: ThreeEvent<PointerEvent>) => setIsHovered(false), []);

    return { isHovered: hovered, bindings: { onPointerEnter: enter, onPointerOut: out } };
}