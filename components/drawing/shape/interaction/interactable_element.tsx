import { DragPoint, SketchInteractable } from "../../../../lib/drawing/sketch/interaction";
import DragSphere from "../drag/sphere";
import * as THREE from "three";

export default function InteractableElement({ interactable, onDrag, onDragEnd }: { interactable: SketchInteractable<any>, onDrag?: (target: any, move: THREE.Vector3) => void, onDragEnd?: (target: any) => void }) {
    ...
    return (<DragSphere position={position} onDrag={(p) => onElementDrag(p)} onDragEnd={() => onElementDragEnd()} />)
}